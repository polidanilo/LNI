          ...
          <div className="flex items-center justify-between max-w-2xl mx-auto">
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.borderColor = editingOrder.status === 'completed' ? '#FF9151' : '#39A8FB';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'white';
                e.currentTarget.style.borderColor = editingOrder.status === 'completed' ? '#39A8FB' : '#FF9151';
              }}
              title={editingOrder.status === 'completed' ? 'Segna come programmato' : 'Segna come effettuato'}
            >
              {editingOrder.status === 'completed' ? (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 group-hover:hidden" viewBox="0 0 20 20" fill="#39A8FB">
              ...
              {editingOrder.status === 'completed' ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 hidden group-hover:block" viewBox="0 0 20 20" fill="#39A8FB">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
              )}
            </button>
              ...
              <div className="flex pt-4 gap-4">
                <div className="flex-1 flex items-center gap-3">
                  ...
                  <select
                    ...
                    className="flex-1 px-0 py-1 bg-transparent border-0 border-b-2 border-primary-azr text-sm text-gray-800 transition-all duration-200 focus:outline-none"
                  >
                ...
                <div className="flex-1 flex items-center gap-3">
                  ...
                  <input
                    ...
                    className="flex-1 pl-1 pt-1 pb-0.5 bg-transparent border-0 border-b-2 border-primary-azr text-sm text-gray-800 transition-all duration-200 focus:outline-none"
                  />
                </div>
              </div>
