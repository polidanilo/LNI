        ...
        <div className="max-w-4xl mx-auto flex items-start justify-between">
          ...
          <div className="flex-1">
            <div 
              ...
              style={{
                height: '80px',
                backgroundImage: 'url(/public/orders3.png)', // ← Modifica qui il nome dell'immagine
      ...
      <div style={{backgroundColor: '#FFF4EF'}} className="px-4 pb-2">
        <div className="px-1 max-w-4xl mx-auto flex gap-3">
          ...
          <select
            ...
            className="px-0 py-1 bg-transparent border-0 border-b-2 border-gray-300 text-sm transition-all duration-200 focus:outline-none focus:border-primary-azr disabled:opacity-50 text-gray-700"
